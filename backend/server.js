...
const PRODUCT_CATALOG = [
    { sortOrder: 1, id: 1, name: 'Liquid Laundry — Heritage', price: 600, image: '/images/Dofoto_20260105_151624084.jpg', imageAlt: 'Liquid laundry detergent 5 litre bottle Sparkles Detergents Kenya', desc: 'Trusted everyday 5L laundry — tough on stains, gentle on hands and colours. Built for family loads and steady weekly washing.', category: 'Laundry', stock: 100 },
    { sortOrder: 2, id: 8, name: 'Liquid Laundry — Skyline', price: 600, image: '/images/sparkles-liquid-laundry-5l.png', imageAlt: 'Sparkles 5 litre blue liquid laundry detergent jerrycan — smart dirt removal, Nairobi Kenya', desc: 'Bold blue jerrycan built for shelf presence. Crisp clean results with our smart dirt-removal branding — full 5 litres for busy homes.', category: 'Laundry', stock: 100 },
    { sortOrder: 3, id: 2, name: 'Hair Shampoo — Pure Balance', price: 699, image: '/images/ChatGPT Image Feb 20, 2026, 11_37_30 AM.png', imageAlt: 'Hair shampoo 5 litre Sparkles bulk bottle Kenya', desc: 'Rich lather powered by natural extracts — soft, manageable hair pour after pour. Generous 5-litre size for the whole household.', category: 'Personal Care', stock: 80 },
    { sortOrder: 4, id: 9, name: 'Hair Shampoo — Silk Sheen', price: 699, image: '/images/sparkles-hair-shampoo-5l.png', imageAlt: 'Sparkles Hair Shampoo 5 litre blue jug — colour care and shine, Nairobi Kenya', desc: 'Sleek blue jug with a focus on colour care, detangling, and mirror-like shine — especially loved for treated or ageing hair. 5 litres.', category: 'Personal Care', stock: 80 },
    { sortOrder: 5, id: 3, name: 'Shower Gel — Fresh Wave', price: 749, image: '/images/Dofoto_20260106_130957947.jpg', imageAlt: 'Shower gel body wash 5 litre Sparkles Detergents Kenya', desc: 'Crisp, moisturising body wash with a scent that stays with you through the day. Easy-rinse gel for daily showers — 5 litres.', category: 'Personal Care', stock: 75 },
    { sortOrder: 6, id: 10, name: 'Shower Gel — Blush', price: 749, image: '/images/sparkles-shower-gel-pink-5l.png', imageAlt: 'Sparkles pink shower gel 5 litre — moisturising body wash, Nairobi Kenya', desc: 'Pink-pack gel with a soft, playful fruit-floral mood. Moisturising rinse that brightens the bathroom shelf — 5 litres.', category: 'Personal Care', stock: 75 },
    { sortOrder: 7, id: 11, name: 'Shower Gel — Berry', price: 749, image: '/images/sparkles-shower-gel-red-5l.png', imageAlt: 'Sparkles red shower gel 5 litre — berry body wash, Nairobi Kenya', desc: 'Red-jug body wash with vibrant, juicy berry notes and a satisfying foam. Full 5 litres for households that like a bold shower scent.', category: 'Personal Care', stock: 75 },
    { sortOrder: 8, id: 4, name: 'Multi-purpose Detergent — All Clear', price: 549, image: '/images/Dofoto_20260106_131334771.jpg', imageAlt: 'Multi-purpose surface cleaner 5 litre Sparkles Kenya', desc: 'One bottle clears floors, tiles, and kitchen tops without juggling three products. Cuts through daily grime — 5 litres.', category: 'Household', stock: 90 },
    { sortOrder: 9, id: 5, name: 'Dish Washing Liquid — Sunrise', price: 449, image: '/images/Dofoto_20260105_150608139.jpg', imageAlt: 'Dish washing liquid 5 litre Sparkles Kenya', desc: 'Fast grease lift with a bright lemon lift-off. The kitchen standby for plates, pots, and pans — 5 litres ready when you are.', category: 'Kitchen', stock: 120 },
    { sortOrder: 10, id: 12, name: 'Dish Washing Liquid — Zesty Lemon', price: 449, image: '/images/sparkles-dishwash-lemon-5l.png', imageAlt: "Mommy D's Sparkles lemon dishwashing liquid 5 litre jug — Kenya", desc: 'Green jug dressed in lime graphics for a cheeky citrus story. Heavy-duty degreasing for busy kitchens — 5 litres.', category: 'Kitchen', stock: 120 },
    { sortOrder: 11, id: 6, name: 'Bleach — Arctic White', price: 499, image: '/images/Dofoto_20260105_145304900.jpg', imageAlt: 'Laundry bleach 5 litre whitening Sparkles Kenya', desc: 'High-strength whitening and disinfecting for whites and stubborn loads. Always follow label directions — 5 litres.', category: 'Laundry', stock: 85 },
    { sortOrder: 12, id: 7, name: 'Fabric Softener — Velvet Linen', price: 900, image: '/images/Dofoto_20260105_150739737.jpg', imageAlt: 'Fabric softener 5 litre Sparkles floral Kenya', desc: 'Towels and bedding stay cloud-soft with a balanced floral whisper after the rinse. Comfort-first finish — 5 litres.', category: 'Laundry', stock: 70 },
    { sortOrder: 13, id: 13, name: 'Fabric Softener — Petal Fresh', price: 900, image: '/images/sparkles-fabric-softener-5l.png', imageAlt: 'Sparkles fabric softener 5 litre pink bottle — floral fragrance, Kenya', desc: 'Pink floral jug with plumeria-style artwork. Long-lasting fragrance for sheets, towels, and everyday favourites — 5 litres.', category: 'Laundry', stock: 70 },
    { sortOrder: 14, id: 14, name: 'Toilet Cleaner — Crystal Bowl', price: 599, image: '/images/sparkles-toilet-cleaner-5l.png', imageAlt: 'Sparkles Toilet Cleaner 5 litre blue jerrycan — bathroom and toilet bowl cleaner, Kenya', desc: 'Powerful toilet and bathroom cleaner in a full 5-litre jug — tackles limescale, stains, and odours with a long-lasting floral-fresh scent. Ideal for busy homes and washrooms.', category: 'Household', stock: 90 },
    { sortOrder: 15, id: 15, name: 'Tile Cleaner — Grout Bright', price: 449, image: '/images/sparkles-tile-cleaner-5l.png', imageAlt: 'Sparkles Tile Cleaner 5 litre orange jerrycan — floor and grout cleaner, Kenya', desc: 'Liquid tile detergent that lifts dark grout and dull tiles back to a bright finish. Long-lasting floral-fresh fragrance — full 5 litres. Use with care; wear gloves.', category: 'Household', stock: 90 },
    { sortOrder: 16, id: 16, name: 'Degreaser — Power Dissolve', price: 699, image: '/images/sparkles-degreaser-5l.png', imageAlt: 'Sparkles Degreaser 5 litre red jerrycan — instant oil removal for floors, tiles and fabrics, Kenya', desc: 'Heavy-duty degreaser for instant oil removal and powerful dissolution — concrete floors, kitchen tiles, and work fabrics. Full 5 litres. Wear gloves.', category: 'Household', stock: 90 },
    { sortOrder: 17, id: 17, name: 'Handwash — Petal Bloom', price: 700, image: '/images/sparkles-handwash-pink-5l.png', imageAlt: 'Sparkles Handwash 5 litre pink jug — gentle natural moisturizing formula, Kenya', desc: 'Gentle, natural, and moisturizing handwash with a soft floral mood. Pink 5-litre jug for busy sinks, kitchens, and washrooms.', category: 'Personal Care', stock: 85 },
    { sortOrder: 18, id: 18, name: 'Handwash — Fresh Dew', price: 700, image: '/images/sparkles-handwash-blue-5l.png', imageAlt: 'Sparkles Handwash 5 litre blue jug — gentle natural moisturizing formula, Kenya', desc: 'Gentle, natural, and moisturizing handwash in a crisp blue jug. Full 5 litres — everyday hand care for home and workplace.', category: 'Personal Care', stock: 85 }
];
...
async function seedProductsIfEmpty() {
    ...
    console.log('Seeded default products (18 items)');
}
